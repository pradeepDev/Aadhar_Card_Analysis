...
object HighestaadhargenprivateAgencies {
    ...
    val df =spark.sql("select  sum(AadharGenerated) as AadharGenerated,PrivateAgency from Aadhar group by PrivateAgency order by AadharGenerated desc limit 3 ")
