...
object PrivateAgenciesInEachState {
  ...
  val dropDisDF=csvData2.dropDuplicates("PrivateAgency", "State").orderBy("State","PrivateAgency")
    dropDisDF.show(dropDisDF.count().toInt,false)
